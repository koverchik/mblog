<div class="theme-steps-list">
	...
	<div class="theme-steps">
		<h3><?php echo esc_html__('Step 1 - Read Full Documentation', 'bloger'); ?></h3>
		...
		<a target="__blank" class="button" href="<?php echo esc_url('http://doc.accesspressthemes.com/bloger/'); ?>"><?php echo esc_html__('Read Documentation', 'bloger'); ?></a>
	</div>
