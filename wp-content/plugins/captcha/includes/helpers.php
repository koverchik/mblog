...
if ( ! function_exists( 'cptch_get_default_options' ) ) {
	...
	function cptch_get_default_options() {
		...
		$default_options = array(
			...
			'cptch_enable_advanced_blocking'        => false,
			...
			'cptch_plugin_activation_status'      => 1,

			'cptch_plugin_install_status'      => 1,
...
if ( ! function_exists( 'cptch_get_plugin_link' ) ) {
	...
	function cptch_get_plugin_link( $plugin ) {
		...
		$bws_link = "https://www.simplywordpress.net?k=%2s&pn=72&v={$cptch_plugin_info["Version"]}&wp_v={$wp_version}/";
	...
	function cptch_get_plugin_name( $plugin_slug ) {
		...
		switch( $plugin_slug ) {
			...
			case 'bws_contact':
				...
				return 'Contact Form by simplywordpress';
