 ...
 * @package Captcha by simplywordpress
 * @since 4.2.3
 */
...
if ( ! class_exists( 'Cptch_Basic_Settings' ) ) {
	class Cptch_Basic_Settings {
		...
		private function save_options() {
			...
			$general_bool    = array( 'load_via_ajax', 'display_reload_button','enable_advanced_blocking', 'enlarge_images', 'enable_time_limit' );
		...
		private function display_general_options() {
			...
			$options = array(
				...
				/*'enable_advanced_blocking' => array(
					'type'	=> 'checkbox',
					'title' => __( 'Enable Advanced Blocking', 'captcha' ),
					'tooltip' => sprintf( __( "This will connect to our database and pull the bad ips on a daily basis if you don't want to talk to our server please leave this unticked ", 'captcha' ))
					 ),*/
