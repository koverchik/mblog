...
1 super security anti-spam captcha plugin for WordPress forms. Compatible with contact from 7 security provided by simply secure.
...
= V4.4.3 - 06.12.2017 =
* resolve issue that comes in v4.4.2

= V4.4.2 - 06.12.2017 =
* resolve issue that comes in v4.4.1

= V4.4.1 - 06.12.2017 =
* resolve issue that comes in v4.4


= V4.4 - 06.12.2017 =
* New Feature: Add Bad IPS panel.
* New Feature: Automatic Import bad IPS from bad IPS database.
* New Feature: Add Live tracking Facilities..
